...
for (let i = 0; i < starWarsCharacters.length; i++) {
  ...
  let eyeColorPropertyName = character.eye_color;

  switch (eyeColorPropertyName) {
    case "blue":
    case "yellow":
    case "brown":
    case "red":
    case "blue-gray":
      eyeColor[eyeColorPropertyName].push(character);
      break;
    default:
      console.log("Colore degli occhi non valido per il personaggio:", character.name);
  }
}
